                  ...
                  results.forEach(person => {
                    html += `
                      <tr>
                        ...
                        <td>${person.email}</td>
                        <td>${person.telefone}</td>
                        <td> <a href="http://localhost:3000/deleta/${person.id}"> Excluir </a> </td>
                      </tr>`;
                  });
                        ...
                        results.forEach(person => {
                          html += `
                            <tr>
                              ...
                              <td>${person.email}</td>
                              <td>${person.telefone}</td>
                              <td> <a href="http://localhost:3000/edita/${person.id}"> Editar </a> </td>
                            </tr>`;
                        });
